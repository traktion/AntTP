...
impl ChunkService {
    ...
    pub async fn create_chunk_binary(&self, bytes: Bytes, evm_wallet: Wallet, cache_only: Option<CacheType>) -> Result<HttpResponse, Error> {
        let chunk_data =  autonomi_chunk::Chunk::new(bytes);
        self.create_chunk_raw(chunk_data, evm_wallet, cache_only).await
    }

    pub async fn create_chunk(&self, chunk: Chunk, evm_wallet: Wallet, cache_only: Option<CacheType>) -> Result<HttpResponse, Error> {
    ...
    pub async fn create_chunk_raw(&self, chunk: autonomi_chunk::Chunk, evm_wallet: Wallet, cache_only: Option<CacheType>) -> Result<HttpResponse, Error> {
